package jp.techacademy.manao.kawamori.jumpactiongame
...
class GameScreen(private val mGame: JumpActionGame) : ScreenAdapter() {
    ...
    private var mEnemySound: Sound = Gdx.audio.newSound(Gdx.files.internal("enemy.mp3"))
    private var mStarSound: Sound = Gdx.audio.newSound(Gdx.files.internal("star.mp3"))
    ...
    init {
        ...
        mPrefs = Gdx.app.getPreferences("jp.techacademy.manao.kawamori.jumpactiongame") // ←追加する
    ...
    private fun createStage() {
        ...
        while (y < WORLD_HEIGHT - 5) {
            ...
            if (mRandom.nextFloat() > 0.7f) {
                ...
                enemy.setPosition(step.x + mRandom.nextFloat(), step.y + Star.STAR_HEIGHT + mRandom.nextFloat() * 5)
                mEnemy.add(enemy)
            }
    ...
    private fun checkGameOver() {
        if ((mHeightSoFar - CAMERA_HEIGHT / 2 > mPlayer.y) || (mHitEnemy == true)) {

            mEnemySound.play(1.0f)
